...
if(isset($_POST['txtsrch']))
	$wcond=$wcond." and b.book_title like '". trim($_POST['txtsrch'])."%' ";	
...
<form name="list" action="search.php" method="POST">
...
<form name="book_list_from" action="search.php" method="POST"> 
